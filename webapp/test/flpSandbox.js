					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Probando Listas",
									"targetURL": "#dhllistas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dhllistas-display": {
								"semanticObject": "dhllistas",
								"action": "display",
								"description": "Aplicacion prueb de listas",
								"title": "Probando Listas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=dhl.listas",
									"url": sap.ui.require.toUrl("dhl/listas")
								}
							}
						}
					}
